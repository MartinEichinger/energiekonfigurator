...
export const Impressum = () => {
  return (
    <ImpressumBody>
      ...
      <p>
        <strong>Tel.:</strong> 08732/939268
        <br />
        <strong>E-Mail:</strong>{' '}
        <a href="mailto:martineichinger@hotmail.com">martineichinger@hotmail.com</a>
      </p>
      <p>
        <strong>Berufsbezeichnung:</strong> Medien Informatiker
      </p>
      ...
      <p>
        Wir haben diese Datenschutzerklärung (Fassung 07.05.2023-322495295) verfasst, um Ihnen gemäß der
        Vorgaben der{' '}
        <a
          href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=322495295#d1e2269-1-1"
          target="_blank"
          rel="noreferrer"
        >
          Datenschutz-Grundverordnung (EU) 2016/679
        </a>{' '}
        und anwendbaren nationalen Gesetzen zu erklären, welche personenbezogenen Daten (kurz Daten) wir
        als Verantwortliche &#8211; und die von uns beauftragten Auftragsverarbeiter (z. B. Provider)
      ...
      <p>
        ...
        <strong>Begriffe leserfreundlich erklärt</strong>, Links zu weiterführenden Informationen geboten
        und <strong>Grafiken</strong> zum Einsatz gebracht. Wir informieren damit in klarer und einfacher
        ...
        möglich, wenn man möglichst knappe, unklare und juristisch-technische Erklärungen abgibt, so wie
        sie im Internet oft Standard sind, wenn es um Datenschutz geht. Ich hoffe, Sie finden die
      ...
      <ol>
        ...
        <li>
          ...
          unsere Website sicher und wirtschaftlich effizient betreiben zu können. Diese Verarbeitung ist
      ...
      <ul>
        <li>
          In <strong>Österreich</strong> ist dies das Bundesgesetz zum Schutz natürlicher Personen bei
          der Verarbeitung personenbezogener Daten (<strong>Datenschutzgesetz</strong>), kurz{' '}
          <strong>DSG</strong>.
        </li>
        <li>
      ...
      <p>
        ...
        nicht mehr vorhanden ist. In einigen Fällen sind wir gesetzlich dazu verpflichtet, bestimmte
        Daten auch nach Wegfall des ursprüngliches Zwecks zu speichern, zum Beispiel zu Zwecken der
        Buchführung.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              basiert, können Sie gegen die Verarbeitung Widerspruch einlegen. Wir prüfen danach so rasch
        ...
        <li>
          ...
          bei der Datenschutzbehörde beschweren, wenn Sie der Meinung sind, dass die Datenverarbeitung
      ...
      <p>
        ...
        datenschutzrechtlichen Ansprüche in sonst einer Weise verletzt worden sind, können Sie sich bei
        der Aufsichtsbehörde beschweren. Diese ist für Österreich die Datenschutzbehörde, deren Website
        Sie unter{' '}
        <a href="https://www.dsb.gv.at/?tid=322495295" target="_blank" rel="noreferrer">
          https://www.dsb.gv.at/
        </a>{' '}
        ...
        <a href="https://www.bfdi.bund.de/DE/Home/home_node.html" target="_blank" rel="noreferrer">
